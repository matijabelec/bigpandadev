bigPandaDP = function(){
    ...
    initDatePicker : function(){
        if($.datepicker.regional[bigPandaDP.getLocale(4)] !== undefined ){
            $.datepicker.setDefaults( $.datepicker.regional[bigPandaDP.getLocale(4)] );
        }else if($.datepicker.regional[bigPandaDP.getLocale(2)] !== undefined){
            $.datepicker.setDefaults( $.datepicker.regional[bigPandaDP.getLocale(2) ] );
        }else{
