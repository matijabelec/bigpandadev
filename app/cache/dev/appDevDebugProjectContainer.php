...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'form.type.datetimepicker' => 'getForm_Type_DatetimepickerService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \BigPandaDev\MainBundle\EventListener\LocaleListener A BigPandaDev\MainBundle\EventListener\LocaleListener instance.
     */
    protected function getApp_LocaleListenerService()
    {
        return $this->services['app.locale_listener'] = new \BigPandaDev\MainBundle\EventListener\LocaleListener('en');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \BigPandaDev\MainBundle\EventListener\UserLocaleListener A BigPandaDev\MainBundle\EventListener\UserLocaleListener instance.
     */
    protected function getApp_UserLocaleListenerService()
    {
        return $this->services['app.user_locale_listener'] = new \BigPandaDev\MainBundle\EventListener\UserLocaleListener($this->get('session'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('app.locale_listener', 'BigPandaDev\\MainBundle\\EventListener\\LocaleListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '3306', 'dbname' => 'big_panda_db', 'user' => 'root', 'password' => 'belec', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/BigPandaDev/MainBundle/Entity'))), 'BigPandaDev\\MainBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('BigPandaDevMainBundle' => 'BigPandaDev\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_adab2c78dca4f67821ef99a62d5167ebbb55df174eff6619d1fe292655a7ed3e');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \BigPandaDev\MainBundle\Form\Type\DatePickerType A BigPandaDev\MainBundle\Form\Type\DatePickerType instance.
     */
    protected function getForm_Type_DatepickerService()
    {
        return $this->services['form.type.datepicker'] = new \BigPandaDev\MainBundle\Form\Type\DatePickerType();
    }
    ...
    /**
     * Gets the 'form.type.datetimepicker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BigPandaDev\MainBundle\Form\Type\DateTimePickerType A BigPandaDev\MainBundle\Form\Type\DateTimePickerType instance.
     */
    protected function getForm_Type_DatetimepickerService()
    {
        return $this->services['form.type.datetimepicker'] = new \BigPandaDev\MainBundle\Form\Type\DateTimePickerType();
    }
    ...
    {
        return $this->services['jms_i18n_routing.loader'] = new \JMS\I18nRoutingBundle\Router\I18nLoader($this->get('jms_i18n_routing.route_exclusion_strategy'), new \JMS\I18nRoutingBundle\Router\DefaultPatternGenerationStrategy('custom', $this->get('translator'), array(0 => 'hr', 1 => 'en'), __DIR__, 'routes', 'en'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('BigPandaDev\\MainBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/lang');
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.our_db_provider')), 'main', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $m, 'main', $o, $p, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'main', $q, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56159016e18457.23245605', $a, $f), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', $q, NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/BigPandaDev/MainBundle/Resources/views'), 'BigPandaDevMain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bf940769c4183e74d15beda421081e8c2f819b78');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CUSTOMER' => array(0 => 'ROLE_USER'), 'ROLE_EMPLOYEE' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_EMPLOYEE', 1 => 'ROLE_CUSTOMER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'BigPandaDevMainBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BigPandaDevMainBundle' => 'BigPandaDev\\MainBundle\\BigPandaDevMainBundle',
            ...
            'database_port' => '3306',
            'database_name' => 'big_panda_db',
            'database_user' => 'root',
            'database_password' => 'belec',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'bf940769c4183e74d15beda421081e8c2f819b78',
            'locale' => 'en',
            ...
            'kernel.secret' => 'bf940769c4183e74d15beda421081e8c2f819b78',
